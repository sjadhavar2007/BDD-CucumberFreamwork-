...
function generateReport() {
  if (!fs.existsSync(cucumberJsonDir)) {
    ...
    report.generate({
      ...
      useCDN: true,
      pageTitle: "Bankjoy Platform Regression Test Automation Report",
      reportName: "Bankjoy Platform Regression - Cypress BDD Test Automation Report",
      metadata: {
        app: {
          name: "Credit Union Portal",
          version: "1",
        },
        browser: {
          name: "Chrome",
      ...
      customData: {
        title: "Run info",
        data: [
          { label: "Project", value: "Bankjoy Platform Regression" },
